  ...
  return (
    <div className="p-1 mx-auto">
      ...
      <section className="mt-16 text-left">
        ...
        <h3
          id="mentions"
          className="font-quicksand !font-bold text-[18px] uppercase mb-3 underline"
        >
          Mentions légales
        </h3>
        <div className="space-y-2">
          ...
          <p className="m-0">Directrice de la publication : Mme Chloé GINES</p>
      ...
      <section id="cgu" className="mt-12 text-left">
        ...
        <h3 className="font-quicksand !font-bold text-[18px] uppercase mb-3 underline">
          Conditions générales d'utilisation (CGU)
        </h3>
        <div>
          {/* -- Objet -- */}
          ...
          <div>
            ...
            <p className="m-0">
              Pour t'inscrire sur Localiz, tu dois avoir <b>au moins 16 ans</b>.
              L'application n'est pas accessible aux mineurs de moins de 16 ans,
              même avec l'autorisation de leurs parents ou tuteurs. Ce choix
              permet de garantir un environnement plus sûr pour l'ensemble des
              utilisateurs, notamment en cas de rencontres physiques.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="m-0">
              ...
              rencontres entre membres, nous rappelons que les échanges d'objets
              ou les rencontres initiés via l'application peuvent impliquer une
            ...
            <ul className="list-disc ml-5 mt-1">
              ...
              <li>en journée,</li>
              <li>
                avec la présence d'une personne de confiance accompagnant chaque
                utilisateur lorsque cela est possible.
              </li>
            </ul>
            <br />
            <p className="m-0">
              Localiz ne pourra être tenu responsable en cas d'incident lors
              d'une rencontre physique. Aussi, ces recommandations s'appliquent
              indépendamment de l'âge des utilisateurs.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="privacy" className="mt-12 text-left">
        ...
        <div>
          ...
          <p className="m-0">
            Quand tu utilises l'application, voici les données que nous pouvons
            collecter :
          </p>
          <ul className="list-disc ml-5 mt-1">
            <li>
          ...
          <ul className="list-disc ml-5 mt-1">
            ...
            <li>
              proposer des contenus et objets pertinents selon ta localisation,
            </li>
          ...
          <ul className="list-disc ml-5 mt-1">
            ...
            <li>
              et <b>notre intérêt légitime</b> à garantir un service sécurisé et
              fiable (article 6.1.f du RGPD).
            </li>
          </ul>
          {/* -- Base légale du traitement -- */}
          <p className="!font-bold mt-6 m-0 underline">
          ...
          <ul className="list-disc ml-5 mt-1">
            <li>
              ...
              favorisant les échanges dans un cadre respectueux et authentique.
            </li>
            <li>
          ...
          <br />
          <p className="m-0">
            <b>Ton nom complet n'est jamais rendu public automatiquement.</b> Tu
            peux choisir d'afficher ou non ton prénom dans ton profil.
          </p>
          ...
          <p className="m-0">
            ...
            (article 45 de la loi Informatique et Libertés). Cela signifie que,
            dès cet âge, un(e) mineur(e) peut légalement accepter le traitement
            de ses données personnelles sans autorisation parentale.
          </p>
          <br />
          <p className="m-0">
            Cependant,{" "}
          ...
          <br />
          <p className="m-0">
            <b>Localiz s'engage à protéger ta vie privée.</b> Toutes tes données
            sont traitées avec la même rigueur que celles d'un adulte. Et, comme
            pour eux, <b>ton nom complet n'est jamais affiché publiquement</b>,
            et <b>ton prénom n'est visible que si tu choisis de le montrer</b>{" "}
            dans ton profil.
          </p>
          ...
          <p className="m-0">
            Les données d'un compte sont conservées <b>tant qu'il est actif</b>.
          </p>{" "}
          <br />
          <p className="m-0">
            ...
            légales. Ensuite, la <b>suppression définitive</b> interviendra dans
            un délai de <b>30 jours</b> après ta demande.
          </p>
      ...
      <section id="rights" className="mt-12 text-left">
        ...
        <div>
          <p className="m-0">
            Conformément au RGPD, tu disposes de plusieurs droits concernant tes
            données :
          </p>
          <ul className="list-disc ml-5 mt-1">
            <li>
            ...
            <li>
              <b>Droit de rectification</b> : corriger des données inexactes ou
              incomplètes,
            </li>
            <li>
              <b>Droit d'opposition</b> : t'opposer au traitement pour certains
              motifs,
            </li>
            <li>
      ...
      <section id="cookies" className="mt-12 mb-8 text-left">
        ...
        <div>
          ...
          <p className="m-0 mt-4">
            Le consentement de l'utilisateur est requis à la première ouverture
            de l'application. Il peut être modifié dans la page{" "}
            <Link
              to="/settings/cookies"
              className="underline"
