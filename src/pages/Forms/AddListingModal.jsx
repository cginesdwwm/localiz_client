                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <Input
                        ...
                        className={`w-full border-2 p-4 focus:outline-none focus:ring-4 transition-all input-surface ${
                          errors.title
                    ...
                    render={({ field }) => (
                      <div>
                        <textarea
                          ...
                          rows="6"
                          {...field}
                          className={`w-full border-2 p-4 focus:outline-none focus:ring-4 transition-all resize-none input-surface placeholder:text-[15px] ${
                            errors.content
                              ? "border-red-500 focus:border-red-500 focus:ring-red-100"
                              : "border-gray-200 focus:border-blue-500 focus:ring-blue-100"
                          }`}
